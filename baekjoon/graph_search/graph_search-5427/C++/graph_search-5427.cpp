...
void print(queue<Pos> &q_jh, queue<Pos> &q_fire, char (*graph)[1001], int (*fire_graph)[1001]);
...
void sol(queue<Pos> &q_jh, queue<Pos> &q_fire, char (*graph)[1001], int (*fire_graph)[1001])
{
...
void input()
{
    ...
    while (t)
    {
        ...
        sol(q_jh, q_fire, graph, fire_graph);
        // print(q_jh, q_fire, graph, fire_graph);
...
int main()
{
    ...
    // 제출 시 주석처리
    freopen("graph_search-5427_input.txt", "r", stdin);
    // 제출 시 주석처리
